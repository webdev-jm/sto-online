...
<div class="row">
    <div class="col-lg-6">
        <h1>[{{$account->account_code}}] {{$account->short_name}} - {{'['.$account_branch->code.'] '.$account_branch->name}} - STOCK TRANSFER</h1>
    </div>
...
@section('content')
    <livewire:stock-transfer.upload :account_branch="$account_branch"/>
@stop
