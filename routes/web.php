...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'permission:account access'], function() {
        ...
        Route::get('account/{id}/edit-template', [AccountController::class, 'template_edit'])->name('account.template-edit');
    });
    ...
    Route::group(['middleware' => 'permission:report access'], function() {
        ...
        Route::get('report/trends', [ReportController::class, 'trends_report'])->name('report.trends');
